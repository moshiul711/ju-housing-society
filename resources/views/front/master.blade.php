                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-center text-lg-right">
                        <div id="topline-animation-wrap">
							...
							<a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection#01656877647372686778416479606c716d642f626e6c"><span class="__cf_email__" data-cfemail="f5919c839087869c938cb5908d9498859990db969a98">[email&#160;protected]</span></a>
						</span>
                                <div class="xs-block">
                                    <ul class="inline-list menu greylinks">
                                        ...
                                        <li class="dropdown"> <a id="search-show" href="index-2.html">
                            ...
                            <div id="topline-show" class="widget widget_search">
                                <form method="get" class="searchform inline-form" action="https://html.modernwebtemplates.com/diversify/">
                                    <div class="form-group-wrap">
                                        <div class="form-group"> <label class="sr-only" for="topline-widget-search">Search for:</label> <input id="topline-widget-search" type="text" value="" name="search" class="form-control" placeholder="Enter Keyword..."> <a href="index-2.html" id="search-close">
